<nav
    ...
    <div class="mb-2 sm:mb-0 inner">
        ...
        <a href="/" class="text-2xl no-underline text-grey-darkest hover:text-blue-dark font-sans font-bold">Название
            сайта</a><br>
        <span class="text-xs text-grey-dark">Подзаголовок</span>
